...
<head>
    ...
    <title>Validation Publication</title>
    <link rel="stylesheet" href="{{ asset('css/valid.css') }}">
</head>
<body>
    <div class="container">
        <header>
            <h1>Validation Publication</h1>
        </header>
        <main>
            <div class="header">
            ...
            <section class="publication-form">
                <h3>Votre publication a été ajoutée <a href="#">voir la publication</a></h3>
